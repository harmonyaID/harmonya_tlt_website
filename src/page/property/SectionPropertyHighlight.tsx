...
const SectionPropertyHighlight = ({ content = {} }: { content?: any }) => {
    return (
        <>
                ...
                <div className="container">
                    <div className="row gx-5 justify-content-between">
                        ...
                        <div className="col-md-6 py-5 px-5">
                            <p className="fs-16 text-green-300">
                                Featured Stay
                            </p>
                            ...
                            <p className="mb-0 text-grey-100 fs-16">
                                ...
                                contemporary, island-styled suites designed to
                                reflect Lord Howe’s pristine natural
                                environment. Capella Lodge is the only island
                                accommodation that offers spectacular views of
                                the Pacific Ocean and towering
                            </p>

                            <BtnLinkBasic className="btn-outline-grey-100 mt-5 rounded-pill">
                                <BtnIcon>RESORT DETAILS</BtnIcon>
                            </BtnLinkBasic>
                        </div>
                    </div>
                </div>
...
export default SectionPropertyHighlight
